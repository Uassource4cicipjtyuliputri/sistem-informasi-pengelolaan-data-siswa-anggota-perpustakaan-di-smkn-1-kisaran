    ...
    <div class="row">
        <div class ="col-xs-12">
            ...
            <div class="alert alert-success">
                <strong>Selamat Datang di SIP Data Siswa Anggota Perpustakaan SMKN 1 Kisaran</strong>
            </div>
        </div>
    </div>
    <div class="row">
            ...
            <div class="panel panel-warning">
                ...
                <div class="panel-body">
                     <table id="dtskripsi" class="table table-bordered table-striped table-hover">
                        <thead>
                            <tr>
                                <th>No.</th><th width="30%">Nomor Anggota</th><th>Nama Anggota</th><th>Tanggal Lahir</th><th>Kelas</th>
                            </tr>
                        </thead>
                        <tbody>
        ...
        <div class="col-sm-3 col-xs-12">
            ...
            <div class="alert alert-info">
                <strong>Welcome <?=$_SESSION['keterangan']?></strong>
            </div>
            <?php
           } else { ?>
