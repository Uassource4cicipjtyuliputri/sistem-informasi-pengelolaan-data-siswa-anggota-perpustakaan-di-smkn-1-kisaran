                    ...
                    <table id="dtskripsi" class="table table-bordered table-striped table-hover">
                        ...
                        <tbody>
                          ...
                          <div class="col-sm-8" align="center">
                            <br>
                            Sistem Informasi Pengelolaan Data Siswa Anggota Perpustakaan Di Sekolah SMK Negeri 1 Kisaran
							Jl.Akasia, Mekar Baru, Kec.Kota Kisaran Barat, Kabupaten Asahan, Sumatera Utara 
                          </div>
                          <div class="col-sm-2" align="center">
                          </div>
                        </tbody>
