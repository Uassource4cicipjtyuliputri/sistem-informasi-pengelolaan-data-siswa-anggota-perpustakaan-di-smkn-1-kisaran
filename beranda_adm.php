    ...
    <div class="row">
        <div class ="col-xs-12">
            ...
            <div class="alert alert-info">
                Selamat datang kembali <strong><?=$_SESSION['username']?></strong>
            </div>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-sm-12 col-xs-12">
            <div class="panel panel-warning">
                <div class="panel-heading">
                    <h3 class="panel-title">Halaman Administrator Sistem Informasi Pengolahan Data Siswa Anggota Perpustakaan SMKN 1 Kisaran</h3>
                </div>
